...
/*
	...
	Call this attribut 'poster', it'll save the path of the poster (image)
	 file for each movie.

	2. Create a page 'index.php'.
	This page will display a nice message like 'Welcome to the freakin 
	movie website' (or whatever)
	...
	This page is a descriptive page for each movie. It'll display the poster,
	 the title, the release year but also the director's name.
	...
	Make the title of each movie clickable. It'll redirect to the related
	 descriptive movie page.

	6. You have to add an attribut to the 'directors' table.
	Call this attribut 'picture', it'll save the path of the picture (image) 
	file for each director.
	...
	This page is a descriptive page for each director. It'll display the picture
	, first name, last name of the director.
	It'll also display ALL the movies from this director.
	This page will have to use the GET method to get the id of the director you want
	 to display.
